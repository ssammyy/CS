...
/**
 * Dialog component for creating new suppliers.
 * Provides a comprehensive form for supplier information entry.
 */
@Component({
  ...
  template: `
    <div class="h-[min(92vh,800px)] overflow-y-auto">
      <div class="px-5 pt-5">
        ...
        <h2 class="text-2xl font-semibold">Create New Supplier</h2>
        <p class="text-gray-600 mt-1 text-sm">Add a new supplier to your procurement system</p>
      </div>
      ...
      <form #supplierForm="ngForm" (ngSubmit)="onSubmit()" class="p-5 pt-3 space-y-6">
        ...
        <div>
          <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
            <mat-icon class="mr-2 text-brand-sky">location_on</mat-icon>
            Address Information
          </h3>
          <mat-form-field class="w-full">
...
export class CreateSupplierDialogComponent {
  ...
  onSubmit(): void {
    if (this.supplier.name.trim() && this.supplier.category && this.supplier.status) {
      ...
      const cleanSupplier: CreateSupplierRequest = {
        ...this.supplier,
